...
void remove_flsh(GtkWidget *widget, gpointer flash)//Flash Removal
{
  ...
  system("kdesudo 'apt-get purge flashplugin-installer gnash mozilla-swfdec'"); 
  ...
  system("kdesudo 'apt-get remove --purge flashplugin-installer'"); 
  system("kdesudo 'apt-get remove --purge flashplugin-nonfree gnash gnash-common mozilla-plugin-gnash '");
  system("kdesudo 'apt-get remove --purge iceweasel-flashplugin mozilla-flashplugin firefox-flashplugin '");
  system("kdesudo 'apt-get remove --purge swfdec-mozilla libflashsupport nspluginwrapper iceape-flashplugin'");
  system("kdesudo 'apt-get remove --purge xulrunner-flashplugin midbrowser-flashplugin xulrunner-addons-flashplugin'");
